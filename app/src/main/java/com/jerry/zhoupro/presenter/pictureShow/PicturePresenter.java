package com.jerry.zhoupro.presenter.pictureShow;
...
public class PicturePresenter extends TitleBaseActivity {
    ...
    public static Intent newIntent(Activity activity, String url, String desc) {
        Intent intent = new Intent(activity, PicturePresenter.class);

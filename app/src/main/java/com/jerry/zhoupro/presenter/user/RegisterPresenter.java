...
public class RegisterPresenter extends TitleBaseActivity {
    ...
    public void onClick(final View view) {
        switch (view.getId()) {
            case R.id.iv_pwd_show:
                ...
                isHidden = !isHidden;
                DisplayUtil.setEditSelection(mPasswdEt);
                break;
    ...
    private void executeVerifyCallBack() {
        ...
        BmobSMS.requestSMSCode(mPhone, sendTime, new QueryListener<Integer>() {
            ...
            public void done(Integer smsId, BmobException ex) {
                ...
                Intent intent = new Intent(RegisterPresenter.this, RegisterVerifyCodePresenter.class);

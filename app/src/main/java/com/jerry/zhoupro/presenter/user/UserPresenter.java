...
import com.jerry.zhoupro.presenter.about.AboutUsePresenter;
import com.jerry.zhoupro.presenter.feedback.FeedbackPresenter;
 ...
 */
public class UserPresenter extends TitleBaseFragment {
    ...
    private void loadViewForCode(ViewGroup view) {
        headView = new UserHeadView(getContext(), new UserHeadView.HeadClickListener() {
            ...
            public void changePicClick() {
                if (UserManager.hasLogin()) {
                    ...
                    startActivityForResult(new Intent(getActivity(), LoginPresenter.class), Key.LOGIN);
                }
            }

            @Override
            public void registerClick() {
                startActivityForResult(new Intent(getActivity(), RegisterPresenter.class), Key.REGISTER);
            }
        ...
        contentView = new UserContentView(getActivity(), new UserContentView.ContentClickListener() {
            ...
            public void feedbackClick() {
                if (UserManager.hasLogin()) {
                    startActivity(new Intent(getActivity(), FeedbackPresenter.class));
                } else {
                    startActivityForResult(new Intent(getActivity(), LoginPresenter.class), Key.TAG_RELEASE_FEEDBACK);
                }
            }
            ...
            public void aboutUsClick() {
                startActivity(new Intent(getActivity(), AboutUsePresenter.class));
            }
        });

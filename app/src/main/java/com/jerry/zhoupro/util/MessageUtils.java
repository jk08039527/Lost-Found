...
//		this.webView = webView;
    ...
    public void confirmWin(final String confirmStr, final String callbackFun) {
        Mlog.d("TAG", "confirmStr:" + confirmStr + "," + callbackFun);
    ...
    public static void showDialog(AlertDialog dialog) {
        ...
        try {
            dialog.show();
            Mlog.d(tag, "3进入showDialog.用于屏蔽home键,和back键.");
            Mlog.d(tag, "5进入showDialog.");
    ...
    public static void showDialog(Builder builder,
        ...
        if (null == builder) {
            Mlog.i(tag, "显示对话框,builder is null.");
            return;
        }

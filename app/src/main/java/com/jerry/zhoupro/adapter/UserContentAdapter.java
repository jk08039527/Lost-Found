...
public class UserContentAdapter extends CommonAdapter<UserMenu> {

    public UserContentAdapter(final Context context, List<UserMenu> userContents) {
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        UserMenu menu = mDatas.get(position);

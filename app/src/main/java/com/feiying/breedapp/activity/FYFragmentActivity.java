...
import com.feiying.breedapp.fragment.FYBaseFragment;
 ...
 */
public abstract class FYFragmentActivity extends FragmentActivity {
    protected List<FYBaseFragment> listKeyDownNotify = new ArrayList<FYBaseFragment>();
     ...
     * @param backStackFlag
     */
    public void changeFragment(FYBaseFragment fragment, boolean backStackFlag) {
    ...
    public void changeFragment(int containId, FYBaseFragment fragment,
    ...
    public void addFragment(FYBaseFragment fragment, boolean backStackFlag) {
        isFragmentBack = false;
        addFragment(R.id.fragments_contain, fragment, backStackFlag);
    }

    public void addFragment(int containId, FYBaseFragment fragment,
    ...
    public void registerKeyDownNotify(FYBaseFragment fragment) {
        if (fragment != null) {
            listKeyDownNotify.add(fragment);
        }
    }

    public void removeKeyDownNotify(FYBaseFragment fragment) {
